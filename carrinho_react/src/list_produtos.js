...
const adicionarAoCarrinho = (produtos) => {
    ...
    //Tela de confirmação e redirecionar
    const confirmacao = window.confirm('Produto adicionado ao carrinho! Deseja ir para página de compra?');
    if (confirmacao) {
        window.location.href = '';  // Tela do carrinho... cena para proximos capitulos
    }
};
